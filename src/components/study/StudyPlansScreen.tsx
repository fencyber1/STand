    ...
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500">Set goals and track your study streaks</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Daily Goal (min)</label>
              <input
                type="number"
                value={dailyGoal}
      ...
      {plans.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-gray-400">Create a plan to set goals and track progress</p>
        </div>
      ) : (
