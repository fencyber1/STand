...
export default function DashboardScreen() {
  ...
  return (
    <div className="min-h-screen px-4 py-4 lg:px-6 lg:py-6 pb-24 lg:pb-6 space-y-5" style={{ background: '#0e1627' }}>
      {/* Greeting */}
      <BorderGlow backgroundColor="#141e35" borderRadius={16} glowColor="270 80 60" glowRadius={30}
glowIntensity={0.8}
edgeSensitivity={40} colors={['#a855f7', '#6366f1', '#ec4899']}>
      ...
      <div className="grid grid-cols-2 gap-3">
        {/* Daily Goal */}
        <BorderGlow backgroundColor="#141e35" borderRadius={16} glowColor="270 80 60" glowRadius={20}
glowIntensity={0.8}
edgeSensitivity={35} colors={['#a855f7', '#c084fc', '#6366f1']}>
        ...
        {/* Streak */}
        <BorderGlow backgroundColor="#141e35" borderRadius={16} glowColor="25 80 60" glowRadius={20}
glowIntensity={0.8}
edgeSensitivity={35} colors={['#f97316', '#fb923c', '#ef4444']}>
          <div className="p-4 relative overflow-hidden">
      ...
      {/* Daily Challenge */}
      {dailyChallenge && (
        <BorderGlow backgroundColor="#141e35" borderRadius={16} glowColor="45 80 60" glowRadius={20}
glowIntensity={0.8}
edgeSensitivity={35} colors={['#f59e0b', '#f97316', '#ef4444']}>
          <div className="p-4 relative overflow-hidden">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {quickActions.map(({ label, desc, icon: Icon, color, glow, glowColor, colors, to }) => (
            <BorderGlow key={label} backgroundColor="#141e35" borderRadius={16} glowColor={glowColor} glowRadius={20}
glowIntensity={0.8}
edgeSensitivity={35} colors={colors}>
              <Link
                to={to}
      ...
      {lastSession && (
        <div>
          ...
          <BorderGlow backgroundColor="#141e35" borderRadius={16} glowColor="270 70 60" glowRadius={25}
glowIntensity={0.8}
edgeSensitivity={35} colors={['#8b5cf6', '#c084fc', '#6366f1']}>
            <div className="p-4">
              <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide">
            {sectors.map((s) => {
              ...
              return (
                <BorderGlow key={s.name} backgroundColor="#141e35" borderRadius={16} glowColor={sc.glow} glowRadius={20} glowIntensity={0.7} edgeSensitivity={30} colors={sc.colors}>
        ...
        <div className="space-y-3">
          {recentSessions.length === 0 ? (
            ...
            recentSessions.map((s) => (
              <BorderGlow key={s.id} backgroundColor="#141e35" borderRadius={16} glowColor={(s.score ?? 0) >= 70 ? '142 70 60' : '25 80 60'} glowRadius={15} glowIntensity={0.7} edgeSensitivity={30} colors={(s.score ?? 0) >= 70 ? ['#22c55e', '#4ade80', '#16a34a'] : ['#f97316', '#fb923c', '#ea580c']}>
